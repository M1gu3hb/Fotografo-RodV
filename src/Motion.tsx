...
export function useScrollReveals() {
  useEffect(() => {
    ...
    const revealTargets = Array.from(document.querySelectorAll<HTMLElement>(
      "main .eyebrow, main .hero__copy-bottom, main .section-index, main .section-heading > p, main .statement p, main .package-card__body, main .package-showcase__detail, main .package-guide__items article, main .package-comparison__rows article, main .package-includes li, main .scroll-chapter, main .book-table > *, main .photobooks__copy > *, main .contact__intro > *, main .contact__form-panel > *, main .archive-link, main .collection-showcase__item, main .story-rail__item, main .filters, main .gallery-pagination",
    ));
